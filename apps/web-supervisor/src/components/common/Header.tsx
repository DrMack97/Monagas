...
// sesión. No incluye navegación de secciones — eso vive en el router
// (App.tsx) una vez que exista; este componente es deliberadamente
// agnóstico de rutas para no acoplarlo prematuramente.
